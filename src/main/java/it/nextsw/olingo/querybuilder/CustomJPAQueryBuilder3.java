...
/**
 * Questa è una classe copiata dal repository github di olingo per risolvere un problema con {@link #normalizeMembers(EntityManager, String)}
 */
@Component
@Scope("prototype")
public class CustomJPAQueryBuilder3 {
    ...
    public CustomJPAQueryBuilder3(ODataJPAContext odataJPAContext) {
...
//    }
    ...
    // =============================== i metodi di sotto sono tutte copiate da github ============================================
